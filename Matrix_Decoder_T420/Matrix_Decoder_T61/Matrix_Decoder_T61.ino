...
// Load an array with the Teensy 3.2 I/O numbers that correspond to the FPC pins
 int con_pin[] = {30,15,32,16,29,17,7,12,25,11,6,10,24,9,5,8,33,4,20,3,21,2,22,1};
//
...
void setup() {
  ...
  delay(3000);  // Wait for the host to connect to the Teensy as a keyboard. If 2 pins are shorted,
